...
public class Finished implements Screen {
    ...
    public Finished(Game game){
        ...
        stage = new Stage(viewport, ((VelocidadeEscaldante) game).batch);
        ...
        Label gameOverLabel = new Label("LEVEL FINISHED WELL DOWN!!!!!", font);
        Label playAgainLabel = new Label("Click to Play on next LEVEL", font);
